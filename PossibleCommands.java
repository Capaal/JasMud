...
public class PossibleCommands {
	...
	public static void create() {	
		...
		AllSkills firebolt = new AllSkills("firebolt", "Syntax: FIREBOLT <target>. You will cast a firebolt to damage your target.", "Firebolt:       Shoots a firebolt at the target.", "firebolt", 20, "magical", 0, 300);
